...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage Member</h4>
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('member.management.add')}}">+ Add Member</a></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('member.management.edit',$value->id)}}" >Edit </a></li>
                                                                

                                                                <li><a href="{{route('member.management.delete',$value->id)}}" onclick="return confirm('Are sure want to delete the data ?')">Delete </a></li>
                                                             </ul>
                                                        </div>
                                                    </td>
                                                </tr>
