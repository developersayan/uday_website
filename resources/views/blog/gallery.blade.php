            ...
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="panel-heading rm02 rm04">
                            <form role="form" action="{{route('manage.blog.images.upload')}}" method="post" id="banner_image_form" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" style="margin-top:25px;">
                                            ...
                                            <a class="btn btn-danger" href="{{route('manage.blog.images.delete',['id'=>$value->id])}}" style="margin-top: 20px;">Delete</a>
