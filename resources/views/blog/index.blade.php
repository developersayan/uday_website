            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('manage.blog.add')}}">+ Add Blog</a></li>
                                        ...
                                        <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{!!substr(@$value->title, 0,100)!!}..</td>
                                                    <td>{!!substr(@$value->description, 0,50)!!}..</td>
                                                    
                                                    <td>
                                                        <img src="{{URL::to('storage/app/public/blog')}}/{{@$value->image}}" style="width:100px;height: 100px;">
                                                    </td>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="{{route('manage.blog.images',$value->id)}}" >Upload Images </a></li>
