                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 text-uppercase font-weight-bold">Members</h4>
                        ...
                        <div class="col-lg-4">
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="{{ URL::to('storage/app/public/testimonial')}}/{{@$value->image}}" style="object-fit: cover;width: 100%;height: 450px;">
                                <div class="bg-white border border-top-0 p-4">
                                    
                                    <a class="h6 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="#">{{@$value->name}}</a>
                                    <a class="h6 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="#">( {{@$value->designation}} )</a>
                                </div>
