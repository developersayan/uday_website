                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('manage.contact.view',$value->id)}}" >View </a></li>

                                                                
                                                                

                                                                <li><a href="{{route('manage.contact.delete',$value->id)}}" onclick="return confirm('Are sure want to delete the data ?')">Delete </a></li>
                                                             </ul>
                                                        </div>
                                                    </td>
                                                </tr>
